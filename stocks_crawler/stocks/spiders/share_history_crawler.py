...
class ShareHistory(object):
    ...
    def get_top_inst_list(task=None):
        """
    ...
    def get_history_data(share_code,task=None,to_market_days=90):
        """
    ...
    def get_sina_dd_ticks(code,task,vol=1,to_market_days):
        """
        获取交易数据
        Parameters
        ----------
